...
event: "FOSDEM 2025"
recording: "https://archive.fosdem.org/2025/schedule/event/fosdem-2025-5829-no-one-used-my-software-a-tale-of-quantum-software-engineering/"
slides: "https://archive.fosdem.org/2025/events/attachments/fosdem-2025-5829-no-one-used-my-software-a-tale-of-quantum-software-engineering/slides/238677/awennerst_MzfYtJR.pdf"
date: 2025-02-02
location: "Brussels, Belgium"
categories:
  - "Quantum Software Engineering"
description: "FOSDEM Quantum devroom talk on real-world quantum software engineering: why the hard part is software, not quantum, and why tools go unused."
excerpt: "Quantum software engineering often fails on product fit. I analyze why useful internal tools stay unused despite technical quality. This improves requirements, architecture choices, and long-term maintenance."
feature_text: "A practical story about building quantum software in industry, from requirements to long-term maintenance."
---
...
<a href="https://www.slideshare.net/slideshow/awennersteen_no-one-used-my-software-pdf/275395986" title="No one used my software: a tale of quantum software engineering" rel="noopener noreferrer" target="_blank">FOSDEM slides</a>
</strong> from <strong>
</strong>
</div></div>
...
> The talk will be high-level with a humorous tone, but we'll use concrete code examples from Pasqal’s open-source software (https://github.com/pasqal-io) to exemplify our points, and the interplay with the wider FOSS community.
>
> Most central to the talk will be Qadence, and its transformation path from a wrapper on top of common frameworks such as Qiskit, Cirq, and Yao.jl where multiple inheritance was the weapon of choice, to an intermediate stage where we tried to make everything as functional as possible, and then to the ongoing compilation efforts in Qadence 2.
>
