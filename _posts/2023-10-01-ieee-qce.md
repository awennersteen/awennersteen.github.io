...
excerpt: "Reflections from IEEE Quantum Week, with a focus on the simulation workshop and the quantum software architecture track. My main takeaways: where performance tuning belongs, how usability interacts with quality attributes, and what the community is converging on."
categories:
