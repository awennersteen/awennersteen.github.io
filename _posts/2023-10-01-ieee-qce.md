...
description: "Gain insights into quantum software architecture trends from IEEE Quantum Week, including simulation, usability, and quality-attribute tradeoffs."
excerpt: "Quantum software architecture debates at IEEE QCE are maturing. Performance, usability, and quality attributes still get mis-scoped. Use clearer boundaries to make trade-offs explicit."
categories:
...
Some thoughts I was left with after this year's IEEE quantum week, with extra focus on the numerical simulation and software architecture workshops.
